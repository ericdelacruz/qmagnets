         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">Q6-1.5 X 6 (includes 1 sheet of QFix6)</a></h1>
              <br>
            ...
            <br>       
       	                   <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">Q6-1.5 </a>
...
<br><br>
<font style="color:#06F; font-weight:bold">$27.00</font>
