...
if(!empty($submit))
{
  ...
  // echo "INSERT INTO `welcome` set `welcome`='".$body."'"; exit;
   ...
   $sql_ins="INSERT INTO `solutions` set `content`='".$body."',title='".$title."',`sub_cat_id`='".$category."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_solutions.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `solutions` set				  	
				  `content`='".$body."',
				  `title`='".$title."',
				  `sub_cat_id`='".$category."'
				  
				   where sol_id ='".$about_id."'";  
   ...
   <?php
$sql_show="select * from solutions where sol_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['sol_id']; ?>" />
              <input type="hidden" name="page" value="<?php echo $page; ?>" />
            <div class="contentbox">
            	    <div id="msg_error" style="color:#FF0000; font-weight:bold;">
                       <h2><?php echo $msg; ?></h2>
                    </div>
            		<?php $q_name=mysql_query("select * from sub_category where category_id='1'");   ?>
				<p>
