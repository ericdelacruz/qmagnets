...
$tinybrowser['obfuscate'] = 'flash0bfu5c4t1on';
...
$tinybrowser['path']['media'] = str_replace($tinybrowser['docroot'],'', preg_replace('[\\\]', '/', realpath(dirname(__FILE__) . '/../../../../../../../media/'))) . '/'; // Media files location
$tinybrowser['path']['file']  = str_replace($tinybrowser['docroot'],'', preg_replace('[\\\]', '/', realpath(dirname(__FILE__) . '/../../../../../../../files/'))) . '/'; // Other files location
*/
