...
if(!empty($submit))
{
 ...
 $sql_ins="INSERT INTO `products` set `content`='".$body."',`prod_cat_id`='".$category."',`image`='".$image."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_products.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `products` set				  	
				  `content`= '".$body."',
				  
				  `image`='".$image."',
				  `prod_cat_id`='".$category."'
				   where prod_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from products where prod_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['prod_id']; ?>" />
            ...
            <div class="contentbox">
				...
				<p>
                    ...
                    <?php }?>
                       ...
                       <p>
                        <label for="textfield"><strong>Product Image:</strong></label>
