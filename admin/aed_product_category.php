...
if(!empty($submit))
{
  ...
  $sql_ins="INSERT INTO `product_category` set `category`='".$category."'"; 
   ...
   <script language="javascript">
        window.location.href='manage_product_category.php?retcode=1&page=<?php echo $page; ?>';
       </script>
   ...
   <?php 
	 ...
	 $sql_ins="update `product_category` set `category`='".$category."'				  	
								  
				   where prod_cat_id='".$about_id."'";  
		$res_ins=mysql_query($sql_ins);	
   ...
   <?php
$sql_show="select * from product_category where prod_cat_id='".$about_id."' ";
        ...
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Product Category Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
             ...
             <!-- <input type="hidden" name="category_id" value="<?php echo $category_id; ?>" />-->
              <input type="hidden" name="about_id" value="<?php echo $row_user['prod_cat_id']; ?>" />
            ...
            <div class="contentbox">
				...
				<p>
                        ...
                        <input type="text" name="category" id="category"   value="<?php echo $row_user['category']; ?>"    class="inputbox" /> 
