...
$blog=isset($_REQUEST['blog'])?addslashes($_REQUEST['blog']):"";
...
if(!empty($submit))
{
  ...
  $sql_ins="INSERT INTO `blog` set `content`='".$blog."',`title`='".$title."',`input_date`='".$date."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_blog.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update  `blog` set `content`='".$blog."',`title`='".$title."',`input_date`='".$date."'
				   where blog_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from blog where blog_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['blog_id']; ?>" />
            ...
            <div class="contentbox">
                  ...
                  <input type="text" name="title" id="title" value="<?php echo $row_user['title'];  ?>" class="inputbox" />
                    ...
                    <p>
                        <label for="date"><strong>Blog Date:</strong></label>
                      <input type="text" name="date" id="date"  value="<?php echo stripslashes($row_user['input_date']); ?>" />
					...
					<p>
                      ...
                      <textarea  name="blog" rows="15" cols="70" style="width: 50%"><?php echo stripslashes($row_user['content']); ?></textarea>
					
                    </p>
                    				
					
                <input type="submit"  class="btn" name="submit" value="Save"/> 
				<a href="manage_blog.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
