...
if($mode=='del')
{
$sql_g="select * from links where linksid='".$del_c_id."' ";
...
while($row_g=mysql_fetch_array($res_g))
 ...
 mysql_query("delete from links where linksid='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `linksid` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `linksid` desc LIMIT $start, $limit";
	}
	//echo $sql;
                	...
                	<thead>
                    	<tr>
						 <th width="6%">Srl No.</th> 
                        	<th width="14%">Links Title</th>
							<th width="14%">Link</th>
                            
                            <th width="16%">Caption </th>
							 <th width="20%">Body</th>
                            ...
                            <td>
							    <?php
										...
										<!--  <a href="<?php echo $_SERVER['PHP_SELF'];?>?del_c_id=<?php echo $id;?>&mode=feature" onClick="Javascript: return confirm('Are You sure want to active this record?')" class="LinkText6"><img src="img/icons/disapprove.gif"  height="15" width="15" border="0" title="Click to active" /></a>-->&nbsp;&nbsp;&nbsp;&nbsp;
										 ...
										 ?>
                            	<a href="aed_links.php?about_id=<?php echo $row['linksid'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<a href="view_links.php?about_id=<?php echo $row['linksid'];?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
