...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `start_sub` set `content`='".$body."', `submenu_id`='".$submenu."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_startsub.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `start_sub` set				  	
				  `content`= '".$body."',
				  `submenu_id`='".$submenu."'
				  
				   where ssub_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from start_sub where ssub_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Start Sub Menus Content Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['ssub_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<?php $q_aboutsub=mysql_query("select * from sub_menu where menu_id='2'");   ?>
