...
<?php
	...
	{
	  $sql=$query." order by `mission_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `mission_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
            	...
            	<table width="100%">
					...
					<?php
                    	...
                    	<tr>
							...
							<td>
							<?php echo stripslashes(substr($row['mission'],0,400)."......");?>
							</td>
                            
                            <td>
							    
                            	<a href="aed_mission.php?about_id=<?php echo $row['mission_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<a href="view_mission.php?about_id=<?php echo $row['mission_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
