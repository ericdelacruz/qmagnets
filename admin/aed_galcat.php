...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `category` set `category`='".$title."'`input_date`='".date('Y'."-".'m'."-".'d')."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_galcat.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `category` set				  	
				  `category`= '".$title."',
				  `input_date`='".date('Y'."-".'m'."-".'d')."'
				  
				   where catid='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from category where catid='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['catid']; ?>" />
            ...
            <div class="contentbox">
					...
					<p>
                      <input type="text" name="title" id="title" value="<?php echo $row_user['category'];  ?>" class="inputbox" />
