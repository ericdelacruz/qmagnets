...
$pathToImages = 'about_img/';
$pathToThumbs = 'product_images/thumb_img/';
if($mode=="feature")
{    
...
if($mode=='del')
{
 ...
 mysql_query("delete from sub_category where sub_cat_id='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `sub_cat_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `sub_cat_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
         ...
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Sub Category
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_category.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
					...
					<?php
						...
						<td align="center"><?php echo $i+1; ?></td>
						    ...
						    <?php
								...
								$subcat=$row['category_id'];
							 	$q_category=mysql_query("select * from category where category_id='".$subcat."' "); 
								$f_category=mysql_fetch_array($q_category);
							 ?>
                        	<td><?php echo $f_category['category']; ?> </td>
							
                            <td><?php echo $row['subcategory']; ?> </td>
                            
                           <td>
                            	<a href="aed_category.php?about_id=<?php echo $row['sub_cat_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<!--<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['sub_cat_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>-->&nbsp;&nbsp;&nbsp;&nbsp;
								<!--<a href="view_aboutpest.php?about_id=<?php echo $row['sub_cat_id'];?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>-->
