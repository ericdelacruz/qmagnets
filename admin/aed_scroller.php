...
if(!empty($submit))
{
  ...
  // echo "INSERT INTO `welcome` set `welcome`='".$body."'"; exit;
   ...
   $sql_ins="INSERT INTO `scroller` set `scroller`='".$image."',`message`='".$message."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_scroller.php?retcode=1&page=<?php echo $page; ?>';
     </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `scroller` set				  	
				  
				  `scroller`='".$image."',`message`='".$message."'
				   where scroll_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from scroller where scroll_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Scroller Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['scroll_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<p>
                      ...
                      <textarea  name="message" rows="15" cols="70" style="width: 50%"><?php echo stripslashes($row_user['welcome']); ?></textarea>
                        ...
                        <span class="smltxt"></span>
							...
							<?php
                              ...
                              <tr >
                                <td >
                                  <input type="hidden" name="image1" value="<?php echo $row_user['scroller']; ?>" style="width:220px;"/> </td>
                                <td>
                                  <?php
									   if(is_file($pathToImages.$row_user['scroller']))
									   {
									   
									  ?>
                                  <img src="<?php echo $pathToImages.$row_user['scroller']; ?>"  width="169" height="119"/>
				...
				<a href="manage_welcome.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
