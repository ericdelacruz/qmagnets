...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `growing_sub` set `content`='".$body."', `submenu_id`='".$submenu."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_growingsub.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `growing_sub` set				  	
				  `content`= '".$body."',
				  `submenu_id`='".$submenu."'
				  
				   where gsub_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from growing_sub where gsub_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Growing Sub Menus Content Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['gsub_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<h3>Growing Sub Menu</h3>		
                     
					 </p> 
					<?php $q_aboutsub=mysql_query("select * from sub_menu where menu_id='3'");   ?>
					
            		<p>
					<select name="submenu">
					<?php while($f_aboutsub=mysql_fetch_array($q_aboutsub)){  ?>
					<option  value="<?php echo $f_aboutsub['submenu_id']; ?>"<?php if($f_aboutsub['submenu_id']==$row_user['submenu_id']){?> selected="selected"<?php } ?>><?php echo $f_aboutsub['submenu']; ?></option>
					<?php }?>
					</select>
				...
				<a href="manage_growingsub.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
