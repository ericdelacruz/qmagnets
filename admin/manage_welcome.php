...
<?php
	...
	{
	  $sql=$query." order by `welcome_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `welcome_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
					...
					<?php
                       ...
                       <td>
							<?php echo $row['title'];?>
                       	   ...
                       	   <td>
							<?php echo stripslashes(substr($row['welcome'],0,400)."......");?>
							</td>
                            ...
                            <td>
							    <?php
										...
										<!--  <a href="<?php echo $_SERVER['PHP_SELF'];?>?del_c_id=<?php echo $id;?>&mode=feature" onClick="Javascript: return confirm('Are You sure want to active this record?')" class="LinkText6"><img src="img/icons/disapprove.gif"  height="15" width="15" border="0" title="Click to active" /></a>-->&nbsp;&nbsp;&nbsp;&nbsp;
										 ...
										 ?>
                            	<a href="aed_welcome.php?about_id=<?php echo $row['welcome_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<a href="view_welcome.php?about_id=<?php echo $row['welcome_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
