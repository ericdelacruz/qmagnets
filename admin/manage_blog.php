...
<?php
	...
	{
	  $sql=$query." order by `blog_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `blog_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
					...
					<?php
                    	...
                    	<tr>
							...
							<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['blog_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<a href="view_blog.php?about_id=<?php echo $row['blog_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
