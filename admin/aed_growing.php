...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `growing` set `growing`='".$body."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_growing.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `growing` set				  	
				  `growing`= '".$body."'
				  
				   where growing_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from growing where growing_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Growing Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['growing_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<p>
                      ...
                      <textarea  name="body" rows="15" cols="70" style="width: 50%"><?php echo stripslashes($row_user['growing']); ?></textarea>
