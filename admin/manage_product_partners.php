...
if($mode=='del')
{
 ...
 mysql_query("delete from product_partner where ppid='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `ppid` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `ppid` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Product Partners
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_product_partners.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
            	...
            	<table width="100%">
                	<thead>
                    	<tr>
							...
							<th>Product Category</th>
 	                    	<th width="33%" >Product Partner</th>
					...
					<?php
                    	...
                    	<tr>
							...
							<td>
							<?php echo $row['partner'];?>
							</td>
                            
                            
                            <td>
							    
                            	<a href="aed_product_partners.php?about_id=<?php echo $row['ppid'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['ppid'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<!--<a href="view_services.php?about_id=<?php echo $row['ppid'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>-->
