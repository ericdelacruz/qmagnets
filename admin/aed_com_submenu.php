...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `about` set `about`='".$body."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_about_submenu.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `menu` set				  	
				  `content`= '".$body."'
				  
				  
				   where menu_id='".$about_id."'"; 
				   
		$res_ins=mysql_query($sql_ins);	
		
		?>
        <script language="javascript">
        window.location.href='manage_com_submenu.php?retcode=1&page=<?php echo $page; ?>';
       </script>
       <?php
	 }  
}
...
<?php
$sql_show="select * from menu where menu_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2> Community & Support Sub Menus  Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['menu_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<h1>Menu:Community & Support</h1>	
                     
					 </p> 
					<?php $q_menu=mysql_query("select * from menu where table_id='4'");   ?>
					
            		<p>
					<?php if($mode=='add'){  ?>
					<select name="menu">
					<?php while($f_menu=mysql_fetch_array($q_menu)){  ?>
					<option value="<?php echo $f_menu['menu_id'];  ?>"><?php echo $f_menu['menu'];   ?></option>
					<?php }?>
					</select>
					<?php }?>
					<?php if($mode=='edit'){ ?>
					
					<h2>Submenu:<?php echo $row_user['menu'];  ?></h2>	
