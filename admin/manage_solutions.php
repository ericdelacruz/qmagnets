...
if($mode=='del')
{
$sql_g="select * from solutions where sol_id='".$del_c_id."' ";
...
while($row_g=mysql_fetch_array($res_g))
 ...
 mysql_query("delete from solutions where sol_id='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `sol_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `sol_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Solutions
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_solutions.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
					...
					<?php
                    	...
                    	<tr>
                            ...
                            <?php 
										...
										$q_page=mysql_query("select * from sub_category where sub_cat_id='".$subcatid."'"); 
										$f_page=mysql_fetch_array($q_page); 
							?>
                            <td><?php echo $f_page['subcategory']; ?></td>
							<td><?php echo $row['title'];   ?></td>
							<td><?php echo stripslashes(substr($row['content'],0,300)."......");?>
							</td>
                            
                            <td>
							    
                            	<a href="aed_solutions.php?about_id=<?php echo $row['sol_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['sol_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<a href="view_solutions.php?about_id=<?php echo $row['sol_id'];?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
