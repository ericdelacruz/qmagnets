...
if($mode=='del')
{
$sql_g="select * from sub_menu where submenu_id='".$del_c_id."' ";
...
while($row_g=mysql_fetch_array($res_g))
 ...
 mysql_query("delete from sub_menu where submenu_id='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `submenu_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `submenu_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Submenu
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_submenu.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
            	...
            	<table width="100%">
					...
					<?php
                    	...
                    	<tr>
                        	<td><?php echo $i+1;  ?></td>
						    <?php 
								$query=mysql_query("select * from menu where menu_id='".$sub."'");
                            ...
                            <td>
							    <?php
										...
										<!--  <a href="<?php echo $_SERVER['PHP_SELF'];?>?del_c_id=<?php echo $id;?>&mode=feature" onClick="Javascript: return confirm('Are You sure want to active this record?')" class="LinkText6"><img src="img/icons/disapprove.gif"  height="15" width="15" border="0" title="Click to active" /></a>-->&nbsp;&nbsp;&nbsp;&nbsp;
										 ...
										 ?>
                            	<a href="aed_submenu.php?about_id=<?php echo $row['submenu_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['submenu_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<!--<a href="view_about.php?about_id=<?php echo $row['submenu_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>-->
