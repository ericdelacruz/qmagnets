...
<?php
	...
	{
	  $sql=$query." order by `eid` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `eid` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Events
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_events.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
            ...
            <div class="contentbox">
            	<table width="100%">
					...
					<?php
                    	...
                    	<tr>
							...
							<td>
							<?php echo stripslashes(substr($row['schedule'],0,200)."......");?>
							</td>
							<td>
							<?php echo stripslashes(substr($row['topics'],0,200)."......");?>
							</td>
							<td>
                ...
                <?php
                            ...
                            <td>
                            	...
                            	<a href="aed_events.php?about_id=<?php echo $row['eid'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['eid'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<a href="view_events.php?about_id=<?php echo $row['eid'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
