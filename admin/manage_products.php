...
$pathToImages = 'product_img/normal/';
$pathToThumbs = 'product_img/thumb/';
...
if($mode=='del')
{
$sql_g="select * from products where prod_id='".$del_c_id."' ";
...
while($row_g=mysql_fetch_array($res_g))
 ...
 mysql_query("delete from products where prod_id='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `prod_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `prod_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Products
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_products.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
            ...
            <div class="contentbox">
            	<table width="100%">
                	<thead>
                    	<tr>
							...
							<th>Product Category</th>
 	                    	<th width="33%" >Product Content</th>
                             <th>Product Image</th>
					...
					<?php
                    	...
                    	<tr>
                            ...
                            <?php 
										$catid=$row['prod_cat_id'];
										$q_prod=mysql_query("select * from product_category where prod_cat_id='".$catid."'"); 
										$f_prod=mysql_fetch_array($q_prod); 
							?>
                            <td><?php echo $f_prod['category']; ?></td>
							
							<td>
							<?php echo stripslashes(substr($row['content'],0,300)."......");?>
							</td>
                ...
                <?php
                            ...
                            <td>
                            	...
                            	<a href="aed_products.php?about_id=<?php echo $row['prod_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['prod_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<a href="view_products.php?about_id=<?php echo $row['prod_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
