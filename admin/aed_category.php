...
$subcat=isset($_REQUEST['subcat'])?addslashes($_REQUEST['subcat']):"";
...
if(!empty($submit))
{
  ...
  // echo "INSERT INTO `welcome` set `welcome`='".$body."'"; exit;
   $sql_ins="INSERT INTO `sub_category` set `subcategory`='".$subcat."', `category_id`='".$category."'"; 
   ...
   <script language="javascript">
        window.location.href='manage_category.php?retcode=1&page=<?php echo $page; ?>';
       </script>
   ...
   <?php 
	 ...
	 $sql_ins="update `sub_category` set `subcategory`='".$subcat."',`category_id`='".$category."'
				  	
								  
				   where sub_cat_id='".$about_id."'";  
		$res_ins=mysql_query($sql_ins);	
   ...
   <?php
$sql_show="select * from sub_category where sub_cat_id='".$about_id."' ";
        ...
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Category  Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
             ...
             <!-- <input type="hidden" name="category_id" value="<?php echo $category_id; ?>" />-->
              <input type="hidden" name="about_id" value="<?php echo $row_user['sub_cat_id']; ?>" />
            ...
            <div class="contentbox">
            	...
            	<p>
                    ...
                    <?php 
					while($f_cat=mysql_fetch_array($cat)) { 
							$catid=$f_cat['category_id'];
					 ?>
                    <option  value="<?php echo $f_cat['category_id']; ?>"<?php if($f_cat['category_id']==$row_user['category_id']){?> selected="selected"<?php } ?>><?php echo $f_cat['category']; ?></option>
                    <?php }?>
                   </select>
                    
                </p>	
				<p>
                        <label for="textfield"><strong>Sub Category:</strong></label>
                        <input type="text" name="subcat" id="subcat"   value="<?php echo $row_user['subcategory']; ?>"    class="inputbox" /> 
                      
                    </p>
                    
					
                <input type="submit"  class="btn" name="submit" value="Save"/> 
				<a href="manage_category.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
