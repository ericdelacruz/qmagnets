...
if(!empty($submit))
{
   ...
   <?php
	 ...
	 $sql_ins="update `menu` set				  	
		...
		?>
        <script language="javascript">
        window.location.href='manage_starting_submenu.php?retcode=1&page=<?php echo $page; ?>';
       </script>
       <?php
	 }  
}
        ...
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2> Starting Sub Menus  Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
            ...
            <div class="contentbox">
					...
					<h1>Menu:Starting New Business</h1>	
                     
					 </p> 
					<?php $q_menu=mysql_query("select * from menu where table_id='2'");   ?>
