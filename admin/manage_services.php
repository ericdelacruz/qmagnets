...
$pathToImages = 'service_img/normal/';
$pathToThumbs = 'service_img/thumb/';
...
if($mode=='del')
{
$sql_g="select * from services where serv_id='".$del_c_id."' ";
...
while($row_g=mysql_fetch_array($res_g))
 ...
 mysql_query("delete from services where serv_id='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `serv_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `serv_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
            ...
            <div class="contentbox">
                ...
                <?php
                            ...
                            <td>
                            	...
                            	<a href="aed_services.php?about_id=<?php echo $row['serv_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['serv_id'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>
								<a href="view_services.php?about_id=<?php echo $row['serv_id'];;?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
