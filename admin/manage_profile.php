...
if($mode=='del')
{
 ...
 mysql_query("delete from activities where pid='".$del_c_id."'"); 
...
<?php
	...
	{
	  $sql=$query." order by `pid` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `pid` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage Our Profile
				 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span style="padding-right:100px;"><a href="aed_profile.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>
            	...
            	<table width="100%">
					...
					<?php
						...
						<td align="center"><?php echo $i+1; ?></td>
							...
							<?php /*?><td>
							<?php 										
							$rw_cat=mysql_fetch_array(mysql_query("select category_name from table_category where category_id='".$row['category_id']."' "));
							echo $rw_cat['category_name'];?>							</td><?php */?>
							<td>
							<?php echo stripslashes(substr($row['content'],0,200)."......");?>
							</td>
                            ...
                            <td>
							    <?php
										...
										<!--  <a href="<?php echo $_SERVER['PHP_SELF'];?>?del_c_id=<?php echo $id;?>&mode=feature" onClick="Javascript: return confirm('Are You sure want to active this record?')" class="LinkText6"><img src="img/icons/disapprove.gif"  height="15" width="15" border="0" title="Click to active" /></a>-->&nbsp;&nbsp;&nbsp;&nbsp;
										 ...
										 ?>
                            	<a href="aed_profile.php?about_id=<?php echo $row['pid'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?php echo $_SERVER['PHP_SELF']?>?del_c_id=<?php echo $row['pid'];?>&mode=del&page=<?php echo $page; ?>" title="Delete" onclick="return confirm('Are you sure to delete this record?');"><img src="img/icons/trash_icon.jpg" alt="Delete" height="15" width="15" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="view_profile.php?about_id=<?php echo $row['pid'];?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>
