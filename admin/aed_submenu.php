...
$submenu=isset($_REQUEST['submenu'])?addslashes($_REQUEST['submenu']):"";
...
if(!empty($submit))
{
   ...
   $sql_ins="INSERT INTO `sub_menu` set `submenu`='".$submenu."',`menu_id`='".$menu."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_submenu.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   <?php
	 ...
	 $sql_ins="update `sub_menu` set				  	
				  `submenu`= '".$submenu."',
				  `menu_id`='".$menu."'
				  
				  
				   where submenu_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from sub_menu where submenu_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Sub Menus  Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['submenu_id']; ?>" />
            ...
            <div class="contentbox">
					...
					<?php $q_menu=mysql_query("select * from menu  ");   ?>
					
            		<p>
					
					<select name="menu">
					<?php while($f_menu=mysql_fetch_array($q_menu)){  ?>
					<option  value="<?php echo $f_menu['menu_id']; ?>"<?php if($f_menu['menu_id']==$row_user['menu_id']){?> selected="selected"<?php } ?>><?php echo $f_menu['menu']; ?></option>
					<?php }?>
					</select>
					...
					<p>
                      ...
                      <input type="text" name="submenu" id="submenu" class="inputbox" value="<?php echo $row_user['submenu'];  ?>" />
					
                    </p>				
									
					
                <input type="submit"  class="btn" name="submit" value="Save"/> 
				<a href="manage_submenu.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
