...
<?php
	...
	{
	  $sql=$query." order by `assist_id` desc ";
	 $start=0;
	}
	else
	{
	 $sql=$query." order by `assist_id` desc LIMIT $start, $limit";
	}
	//echo $sql;
        ...
        <!-- Alternative Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>Manage We Assist
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<!--<span style="padding-right:100px;"><a href="aed_assist.php?mode=add" style="text-decoration:none; border:0px; "><img src="img/icons/addanother.png" alt="Edit" height="25" width="90" border="0" /></a></span>-->
					...
					<?php
                    	...
                    	<tr>
                            ...
                            <td>
                            	...
                            	<a href="aed_assist.php?about_id=<?php echo $row['assist_id'];?>&mode=edit&page=<?php echo $page; ?>" title="Edit Page"><img src="img/icons/edit_icon.jpg" alt="Edit" height="15" width="15" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<!--<a href="view_solutions.php?about_id=<?php echo $row['assist_id'];?>" onclick="return hs.htmlExpand(this, { objectType: 'iframe' } )"><img src="img/icons/view.gif" alt="Approve" /></a>-->
