...
if(!empty($submit))
{
	...
	if($valid==1 && $mode=='add')
   	{  	
		move_uploaded_file($_FILES['image']['tmp_name'],$dest);
  		...
  		$sql_ins="INSERT INTO `right_banner` set `banner`='".$image."'"; 
		...
		?>
			<script language="javascript">
            	window.location.href='manage_right_banner.php?retcode=1&page=<?php echo $page; ?>';
            </script>
        <?php
		}	
	}
	...
	if($valid==1 && $mode=='edit')
	{
		...
		$sql_ins="update `right_banner` set `banner`= '".$image."' where `rbanid`='".$banid."'";
		$res_ins=mysql_query($sql_ins);	 
...
$sql_show="select * from right_banner where rbanid='".$banid."' ";
    ...
    <div id="rightside">
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="banid" value="<?php echo $row_user['rbanid']; ?>" />
              <input type="hidden" name="page" value="<?php echo $page; ?>" />
            	<div class="contentbox"> 
					...
					<p>
                        <label for="textfield"><strong> Banner Image:</strong>(Size of the image should be 431 X 339)</label>
				...
				<a href="manage_right_banner.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
