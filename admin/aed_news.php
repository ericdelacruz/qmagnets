...
if(!empty($submit))
{
  ...
  $sql_ins="INSERT INTO `news` set `content`='".$body."',`title`='".$title."',`input_date`='".date('Y'."-".'m'."-".'d')."',`image`='".$file."',`timage`='t".$file."'"; 
	$res_ins=mysql_query($sql_ins);	
	?>
     <script language="javascript">
        window.location.href='manage_news.php?retcode=1&page=<?php echo $page; ?>';
  </script>
    <?php
   ...
   $sql_ins="update `news` set				  	
				  `content`= '".$body."',
				   `title`='".$title."',
				   `input_date`='".date('Y'."-".'m'."-".'d')."',
				   `image`='".$file."',
				   `timage`='t".$file."'
				   where news_id='".$about_id."'"; 
   ...
   <?php
$sql_show="select * from news where news_id='".$about_id."' ";
    ...
    <div style="clear:both;"></div>
        <!-- Content Box Start -->
         <div class="contentcontainer">
            <div class="headings altheading">
                <h2>News Add / Edit <span style="padding-right:100px;"><a href="../" style="text-decoration:none; border:0px;" target="_blank"><img src="img/icons/preview.png" alt="Edit" height="25" width="90" border="0" /></a></span></h2>
            </div>
			<div style="clear:both;"></div>
		...
		<div class="status success" id="success"  onclick="cls()">
		 ...
		 ?>
              ...
              <input type="hidden" name="about_id" value="<?php echo $row_user['news_id']; ?>" />
            ...
            <div class="contentbox">
                    ...
                    <input type="text" name="title" id="title" class="inputbox" value="<?php echo stripslashes($row_user['title']); ?>" />
					...
					<p>
                        <label for="textfield"><strong>News Content:</strong></label>
				...
				<a href="manage_news.php"><input type="cancel"  class="btnalt" name="cancel" value="Cancel"/></a>
