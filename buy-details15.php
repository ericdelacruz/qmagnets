         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">QF10-3 </a></h1>
              <br>
            ...
            <img src="images/QF10-3hr.jpg" width="400" height="400"> 
            <br>       
       	                   <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none"> QF10-3  </a>
...
<br><br>
<font style="color:#06F; font-weight:bold">$12.00</font>
