  ...
  <div class="main"> 
    ...
    <div class="body_area">
         <div class="body_box">
          ...
          <h3><a href="bodymap.php">Your Pain</a> &gt;&gt; Q magnet Prescription for ankle pain:</h3>
            <p class="centeredImageLink">
              <a href="images/Slide17.jpg">
                <img src="images/ankleoutside.gif" alt="Elbow" /><br>
                Click image for more details.
              </a>
            </p>
            
            <p><strong>Outside Ankle</strong>
              <br><br>
              Application of Q magnets to the ankle is shown. One device is placed in the groove felt by gently pressing in front of the anklebone on the outside of the ankle.
            </p>
            
            <iframe width="480" height="360" src="http://www.youtube.com/embed/BEg4NrRR5I8" frameborder="0" allowfullscreen></iframe>
          
            <p class="centeredImageLink">
              <a href="images/Slide17.jpg">
                <img src="images/ankleinside.gif" alt="Ankle" /><br>
                Click image for more details.</a>
            </p>
            
            <p><strong>Inside Ankle</strong>
              <br><br>
              Another is placed in the groove felt by gently pressing behind the anklebone on the inside of the ankle.
            </p>
            
            <a href="http://www.qmagnets.com/blog/category/pain-testimonies/ankle-pain">Click here for Q magnet testimonies for ankle pain.</a>
            ...
            <tbody>
             <tr>
                <td>Severe</td>
                <td>2 X QF28-3</td>
                <td><a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&ProductID=3366288"><img src="images/cart.jpg" alt="Add to shopping cart" width="134" height="23" border="0" /></a> $118.00</td>
              </tr>
             <tr>
                <td>Moderate</td>
                <td>2 X QF20-3</td>
                <td><a href="http://www.1shoppingcart.com/SecureCart/SecureCart.aspx?mid=BDA24534-D9B5-4373-886C-06EB27E1F088&pid=b3fe6613c2bd4ee4b7cd055ed141d43f"><img src="images/cart.jpg" alt="Add to shopping cart" width="134" height="23" border="0" /></a> $66.00 </td>
              </tr>
            </tbody>
            <tfoot>
             <tr>
