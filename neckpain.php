    ...
    <div class="body_area">
         <div class="body_box">
          ...
          <div class="body_text_area">
           ...
           <br><br>
           <p ><span class="strong">Three Q magnet Placement:</span></p>
...
Find the bulge at the base of the neck, this is the 7th cervical vertebra. If you go just above the bulge, that is the space between the 6th and 7th cervical vertebrae. The  first device is placed approximately 40mm (1.5 inches) to the left of the midline. The second device is placed at the same level approximately 40mm (1.5 inches) to the right of midline.
  ...
  To find the first and second placements at the base of the neck easily, place them to the right and left of the midline at the points that are tender when pressed. The  third device  is placed approximately 50mm (2 inches) above the bulge at the base of the neck at the 4th cervical vertebra. For most people, this level is usually the hairline.
           ...
           <br><br><br>
           <iframe width="420" height="315" src="http://www.youtube.com/embed/qpwKh-tYUvQ?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
           <br><br>
           <p class="centeredImageLink">
            <a href="images/Slide5.jpg">
              <img src="images/NS-4device.gif">
             <br>
             Click on image for more details.
           </a>
 			</p>
            ...
            <a href="http://qmagnets.com/blog/category/pain-testimonies/neck-pain" class="links">Click here for Q magnet testimonies for neck pain.</a>
            ...
            <tbody>
              <tr>
                <td>Severe </td>
                <td>2 X QF28-3 + 2 X QF20-3 (4 device array)</td>
                <td>$184.00 <a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&amp;ProductID=3366213"><img width="134" height="23" border="0" alt="Add to shopping cart" src="images/cart.jpg"></a></td>
              </tr>
              <tr>
                <td>Severe </td>
                <td>1 X QF28-3 + 2 X QF20-3 (3 device array)</td>
                <td>$125.00 <a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&amp;ProductID=3366224"><img width="134" height="23" border="0" alt="Add to shopping cart" src="images/cart.jpg"></a></td>
              </tr>
              <tr>
                <td>Moderate</td>
                <td>3 X QF20-3</td>
                <td>$99.00 <a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&amp;ProductID=3366228"><img width="134" height="23" border="0" alt="Add to shopping cart" src="images/cart.jpg"></a></td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
                <td colspan="3">For best value purchase the <a href="products.php#QBP">Q
                  Bonus Package</a></td>
              </tr>
            </tfoot>
            </table>
