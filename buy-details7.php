         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">OF28-3</a></h1>
              <br>
            ...
            <img src="images/QF28-3hr.jpg" width="400" height="400"> 
            <br>       
       			                   <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">  OF28-3 </a>
...
<br><br><br>
Dosimetry on the QF28-3 shows the alternating poles. The red segments represent recordings over the positive poles and blue the negative.
...
<br><br>
The QF28-3 device is slimmer than the QF28-6 device and may be more comfortable to wear, especially for lean individuals with a small frame. The QF28-3 device is best suited for use on the lower back, upper back and larger joints such as hip, shoulder and knee.
...
<br><br>
Use of QF28-3 over the <a href="shoulderpain.php" style="color:#6d94cd; font-weight:bold; font-size:12px; text-decoration:none">shoulder</a>. 
<br><br>
<img src="images/shoulder-pain.jpg" width="400" height="267">
<br><br>
