         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">QF20-3  </a></h1>
              <br>
            ...
            <img src="images/QF20-3hr.jpg" width="400" height="400"> 
            <br>       
       	                   <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">  QF20-3  </a>
...
<br><br>
<font style="color:#06F; font-weight:bold">$33.00</font>
...
<br><br>
<iframe width="400" height="315" src="http://www.youtube.com/embed/BEg4NrRR5I8?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
<br><br>
...
<br><br>
The QF20-5 device is seen here (left) on the outside of the elbow over the lateral epicondyle which is the placement for <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none"> chronic neck pain</a>.
<br><br>
...
<br><br>
<img src="images/neck-pain-QF28-3-4.jpg">
<br><br>
...
There are four different models of the QF20 family, 20mm diameter Q magnets - QF20-5, QF20-4, QF20-3 and QF20-2. While the depth of penetration does not vary a lot between the thinest and thickest, the thicker the magnet, the denser and stronger the magnetic flux. So as a general rule, use the thickest device that is comfortable and practical to wear. 
<br><br>
The QF20-5 device is seen here (left) on the outside of the elbow over the lateral epicondyle which is the placement for <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none"> golfers elbow.</a>.
<br><br>
Any of the devices can be sewn into or onto braces once the best placements have been determined. They can also be placed inside of socks or tubular elastic material such as <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none">tubigrip</a>.  
<br><br>
<img src="images/elbow-pain4.jpg">
<br><br>
Use of a QF20 model over the <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none">ankle</a>. 
<br><br>
