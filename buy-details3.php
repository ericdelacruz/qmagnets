...
<div id="main_area">
  <div class="main"> 
         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> Q Bonus Package-<a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">General Use</a></h1>
            </div>
   ...
   <br>
   <br>
 <img src="images/shoulder-pain.jpg">
 <br>
 QF28-3 ans QF20-3 used for shoulder pain
 <br><br>
 <img src="images/ankle-pain3.jpg">
 <br>
 QF20-3 Q magnets can be affixed to the skin with the double sided adhesive or with sports tape over the top.
 <br>
