         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            <div class="body_heading_bg">
              <h1> <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none">QF10-2 </a></h1>
              <br>
            ...
            <img src="images/QF10-2hr.jpg" width="400" height="400"> 
            <br>       
       	                   <a href="buy.php" style="color:#6d94cd; font-weight:bold; font-size:18px; text-decoration:none"> QF10-2  </a>
...
<br><br>
<font style="color:#06F; font-weight:bold">$10.00</font>
...
<br><br>
There are two different models in the QF10 family, 10mm diameter Q magnets - QF10-3 and QF10-2. While there is negligible difference in the depth of penetration between the two, the thicker the magnet, the denser and stronger the magnetic flux. So as a general rule, use the thickest device that is comfortable and practical to wear. In addition, the smaller the device, the more accurate the placement is needed. If the Q magnet is slightly off position, the field will not reach the target tissue and it will have little or no effect.
<br><br>
The QF10-2 device is seen here (left) on the wrist.
<br><br>
<img src="images/hand-pain1.jpg">
<br><br>
...
Any of the devices can be sewn into or onto braces once the best placements have been determined. They can also be placed inside of socks or tubular elastic material such as <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none"> tubigrip</a>.
 <br><br>
 <a href="#" style="color:#6d94cd; font-weight:bold; font-size:14px; text-decoration:none">Wrist pain</a> (left) with adhesive tape using Hypafix, also called Fixomull or Cover-Roll.
 <br><br>
