         ...
         <div class="body_box">
          ...
          <div class="body_text_area">
            ...
            <div class="about_body_text_box">
             ...
             <div class="centered">
                <a href="images/Slide9.jpg"><img src="images/hipfront.gif"></a>

             <br><br>
            <a href="images/Slide9.jpg" class="links">Click on image for more details.</a> 
            </div>
            <br><br>
           ...
           <br><br>
           <div class="centered">
          <a href="images/Slide10.jpg"><img src="images/hipside.gif"></a>              
            <br>
            <a href="images/Slide10.jpg" class="links">Click on image for more details</a>
            <br><br>
          </div>
          ...
          <br><br><br><br>
          <a href="http://qmagnets.com/blog/category/pain-testimonies/hip-pain" style="color:#CCB363; font-weight:bold; font-size:14px">Click here for Q magnet testimonies for hip pain</a>
          <br><br>
          <table class="tablelist1" width="100%" cellspacing="0" cellpadding="10" border="1">
            <thead>
              <tr>
                <td>Pain Level </td>
            ...
            <tbody>
              <tr>
                <td>Severe </td>
                <td>2 X QF28-6, 1  X QF28-3</td>
                <td>$197.00 <a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&amp;ProductID=3366348"><img width="134" height="23" border="0" alt="Add to shopping cart" src="images/cart.jpg"></a></td>
              </tr>
              <tr>
                <td>Moderate</td>
                <td>3 X QF20-3</td>
                <td>$99.00 <a href="http://www.1shoppingcart.com/app/netcart.asp?MerchantID=96291&amp;ProductID=3366349"><img width="134" height="23" border="0" alt="Add to shopping cart" src="images/cart.jpg"></a></td>
              </tr>
              <tr>
